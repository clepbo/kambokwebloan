...
<html lang="en">
    ...
    <body>
        <!-- Top of page -->
        <div class="alert hide " id="alert-msg">
            <span class="fa-solid fa-exclamation"></span>
            <span class="msg">Warning: Incorrect Pin!</span>
            <span class="fa-solid close-btn">
        ...
        <%
            ...
            Ads ads = data.Database.GetLoanAdsViaId((String) session.
                    getAttribute("adsId"));
        %>
                                                    ...
                                                    <div class="col-md-12 my-4">
                                                        <form class="form">
                                                            <div class="form-group">
                                                                <label class="label text-dark">Enter Amount <button type="button" class="info-btn" data-bs-toggle='modal' data-bs-target='#myModal2'><i class="fa-solid fa-circle-info"></i></button></label><br>
                                                            ...
                                                            <div class="row my-2">
                                                                <b id="report" class="text-danger"></b><br>
                                                                <div class="col-md-12 d-flex justify-content-between my-2">

                                                                    <div class="col">
                                                                        <button type="button" style="width: 100px; font-weight: bold; letter-spacing: 2px; font-size: 20px;" class="btn btn-success" id="investBtn" data-bs-toggle='modal' data-bs-target='#myModal'>Invest</button>
                                                                    </div>
                                                                    <div class="col">
                                                                        <a href="investment-news-feed.jsp" class="btn btn-danger" style="width: 100px; font-weight: bold; letter-spacing: 2px; font-size: 20px;">Close</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>       
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h4 class="modal-title text-info text-center">Transaction Authorization</h4>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row pin-container d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="form d-flex justify-content-center align-items-center">
                                                <form action="#" method="get" class="otp-bx" autocomplete="off">
                                    ...
                                    <div class="modal-footer d-flex justify-content-between">
                                        <form>
                                            <input type="hidden" name="adsAmount" id="adsAmount" value="<%=ads.getAdsAmount()%>">
        ...
        <script>
                    ...
                    const form = document.querySelector(".otp-bx");
                    ...
                    form.action = "test.html";
                            ...
                            alertmsg.classList.add("hide");
                                    ...
                                    input.value = "";
                                            ...
                                            btn.style.transition = "0.3s ease-out";
